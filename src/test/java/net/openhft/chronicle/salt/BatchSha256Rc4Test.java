...
public class BatchSha256Rc4Test {
    ...
    static Stream<Arguments> data() throws IOException {
        ...
        for (Map<String, Object> data : testData) {
            ...
            params.add(Arguments.of(name, size, hash));
    ...
    public void testHash(String name, long size, String sha256) {
        ...
        assertEquals(sha256Expected.toHexString(SHA2.HASH_SHA256_BYTES), sha256Actual.toHexString(SHA2.HASH_SHA256_BYTES), "sha256: vector " + name);
