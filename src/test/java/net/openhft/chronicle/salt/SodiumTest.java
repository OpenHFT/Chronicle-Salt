...
public class SodiumTest extends BytesForTesting {
    ...
    public void crypto_box_curve25519xsalsa20poly1305_keypair() {
        ...
        assertEquals(0, SODIUM.crypto_box_curve25519xsalsa20poly1305_keypair(secretKey0.addressForWrite(32),
                secretKey0.addressForWrite(0)));
        ...
        assertEquals(0, SODIUM.crypto_sign_ed25519_seed_keypair(publicKey.addressForWrite(0),
                secretKey.addressForWrite(0), secretKey0.addressForRead(0)));
    ...
    public void signAndVerify() {
        ...
        assertEquals(0, SODIUM.crypto_sign_ed25519_seed_keypair(publicKey.addressForWrite(0),
                secretKey.addressForWrite(0), privateKey.addressForRead(0)));
        publicKey.readPositionRemaining(0, 32);
        secretKey.readPositionRemaining(0, 64);
        ...
        assertEquals(0, SODIUM.crypto_sign_ed25519(sigAndMsg.addressForWrite(0), new LongLongByReference(0),
                emptyMsg.addressForRead(0), 0, secretKey.addressForRead(0)));
        ...
        assertEquals(0, SODIUM.crypto_sign_ed25519_open(buffer.addressForWrite(0), new LongLongByReference(0),
                sigAndMsg.addressForRead(0), 0 + 64, publicKey.addressForRead(0)));
    ...
    public void signAndVerify2() {
        ...
        assertEquals(0, SODIUM.crypto_sign_ed25519(sigAndMsg.addressForWrite(0), sigLen, message.addressForRead(0),
                (int) message.readRemaining(), secretKey.addressForRead(0)));
        checkZeros(sigAndMsg);
        ...
        assertEquals(0, SODIUM.crypto_sign_ed25519_open(buffer.addressForWrite(0), bufferLen,
                sigAndMsg.addressForRead(0), 210, publicKey.addressForRead(0)));
