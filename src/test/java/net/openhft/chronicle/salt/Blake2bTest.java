...
public class Blake2bTest {
    ...
    public void testHash512() {
        ...
        doTestBlake2b512(
                DatatypeConverter.parseHexBinary("000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b"
        ...
        doTestBlake2b512(
                DatatypeConverter.parseHexBinary("000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f"
    ...
    public void testMultiPart512() {
        ...
        assertMultiPart512(multi,
                ...
                nativeBytesStore("abcdefgh"), nativeBytesStore("ijklmnop"), nativeBytesStore("qrstuvwxyz"));
