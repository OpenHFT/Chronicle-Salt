= Chronicle Salt – Java binding to libsodium (NaCl)
:lang: en-GB
...
This library natively supports Chronicle Bytes and can sign and verify data entirely off-heap.
This saves copying data to/from `byte[]` (not creating them).
