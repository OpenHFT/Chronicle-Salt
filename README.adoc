...
=== Generating a public and secret key from a seed
 ...
 - A public and secret key need to be generated as they are used to sign a message, making it secure and allowing the receiver to know      who sent the message.
